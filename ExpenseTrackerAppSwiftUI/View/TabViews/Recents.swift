...
struct Recents: View {
    ...
    //for geometry matched , animation category in seg control
                        ...
                        Section {
                            ...
                            Button(action: {
                                ...
                                Text("  to  ")
                                    .bold()
                                +
                                Text("\(format(date: endDate, format: "dd - MMM yy"))")
                            })
                            .font(.caption2)
