        ...
        VStack(spacing: 15.0) {
            ...
            VStack(alignment: .leading, spacing: 25) {
                PointView(
                    symbol: "dollarsign",
                    title: "Transactions",
                    subTitle: "Keep track pf your earnings and expenses."
                )
                PointView(
                ...
                PointView(
                    ...
                    title: "Advance filtes",
                    subTitle: "Find the expense you want by advance search and filtering."
                )
            }
